    ...
    return (
        <>
          ...
          <div className="page-header">
            <h2>Meine Agenda-Punkte</h2>
          </div>
          <div className="page-header-seperator-col2"></div>
          <div className="page-header-seperator-col3"></div>
          
          <div className="my-agenda-table-content">
            <div className="my-agenda-table">
              <div className="my-agenda-table-col1"></div>
              <div className="table agenda-table">
                ...
                <TopicsList useAuthtoken={true} onlyOpen={false} />
              </div>
            </div>
          </div>
        </>
